...
@override
  ...
  @override
  Future<Either<Failure,String>> deleteTVSeriesWatchlist(TVSeriesDetail series) async{
    try{
      final result = await localDataSource.deleteTVSeriesWatchlist(TVSeriesTable.fromEntity(series));
      return Right(result);
    } on DatabaseException catch (e){
      return Left(DatabaseFailure(e.message));
    }
